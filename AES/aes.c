 ...
 * 参数 key: 密钥的字符串数组。
 */
unsigned char aes(char *p, int plen, char *key){
 ...
 * 参数 key: 密钥的字符串数组。
 */
unsigned char deAes(char *c, int clen, char *key) {
